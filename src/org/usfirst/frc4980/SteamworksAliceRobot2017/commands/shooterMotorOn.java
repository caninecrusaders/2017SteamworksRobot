...
public class shooterMotorOn extends Command {
    ...
    protected void initialize() {
    	RobotMap.shootershooterMotor.set(1.0);
    	isShooting = true;
    }
    ...
    protected void execute() {
    	...
    	if(!j.getIsXbox()){
    		//max cim power at 2655 rpms
    		double joystickSpeed = (j.getRawAxis(3)+1.0)/2.0;
    		speed = joystickSpeed*5000; //Logitech Slider 
    		if(j.getRawButton(2)){
    			isShooting = true;
    		}
