...
public class OI {
	...
	public JoystickButton xboxButtonLB;
	public JoystickButton xboxButtonRB;
	public JoystickButton xboxButtonBack;
   ...
   // public Joystick joystick1;
    ...
    public OI() {
        ...
        xboxButtonA.whileHeld(new BallGateRelease());
        ...
        xboxButtonLB = new JoystickButton(xbox, 5);
        xboxButtonLB.whenPressed(new GearLeanOut());
        xboxButtonRB = new JoystickButton(xbox, 6);
        xboxButtonRB.whenPressed(new GearLeanIn());
        xboxButtonX = new JoystickButton(xbox, 3);
        xboxButtonX.whenPressed(new ShooterMotorAutoRPM());
        xboxButtonBack = new JoystickButton(xbox, 7);
        xboxButtonBack.whenPressed(new climberClimb());
	    ...
	    joystickButton1.whileHeld(new ShooterMotorAutoRPM());
	    joystickButton2 = new JoystickButton(joystick, 2);
        ...
        joystickButton11.whenPressed(new toggleInvert());
        joystickButton10 = new JoystickButton(joystick, 10);
        joystickButton10.whenPressed(new shooterMotorTestDown());
//        joystickButton12 = new JoystickButton(joystick, 12);
//        joystickButton12.whenPressed(new collectorMotorOn());
        joystickButton8 = new JoystickButton(joystick, 8);
        joystickButton8.whenPressed(new collectorMotorAuto());
        joystickButton7 = new JoystickButton(joystick, 7);
        joystickButton7.whenPressed(new climberClimb());
        joystickButton9 = new JoystickButton(joystick, 9);
        joystickButton9.whenPressed(new ClearStickyFaults());
